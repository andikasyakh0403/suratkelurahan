...
class Autentifikasi extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            if ($user['status'] == 'verfikasi'AND $user['idrole']  == 1) {
                //cek password
    ...
    public function masuk()
    {
        ...
        $this->session->set_flashdata('berhasil', '<div class="alert alert-success alert-message" role="alert">Selamat!! akun member anda sudah dibuat. Silahkan Aktivasi Akun anda</div>');
        redirect('autentifikasi');
    }
