...
<div class="container" style="background-color: white; border-radius: 10px"><br>
      ...
      <?= $this->session->flashdata('pesan'); ?>
                              <h1 class="h4 text-gray-900 mb-4" font="timnes">Ubah Surat Izin Keramaian</h1>
                          </div>
                          <form class="user" method="post" action="<?= base_url('user/updatesuratramai'); ?>" enctype="multipart/form-data" >
                            
                            
                          <div class="form-group">
                                  <input type="text" class="form-control" id="nosurat" name="nosurat" placeholder="Masukan NIK"   
                                  hidden
                                  value="<?= $suratramai["nosurat"]; ?>">
                              ...
                              <div class="form-group">
                                  <input type="text" class="form-control" id="hari" name="hari" placeholder="hari" value="<?= $suratramai["hari"]; ?>"> 
                              ...
                              <div class="form-group">
                                  <input type="date" class="form-control" id="tgl" name="tgl" placeholder="tanggal"  value="<?= $suratramai["tgl"]; ?>"> 
                                  <?= form_error('tgl', '<small class="text-danger pl-3">', '</small>'); ?>
                              </div>
                              <div class="form-group"align="justify">
                              <label for="selesai" >jam mulai:</label>
                                  <input type="time" class="form-control" id="jam" name="jam" placeholder="jam mulai" value="<?= $suratramai["jam"]; ?>"> 
                                  <?= form_error('jam', '<small class="text-danger pl-3">', '</small>'); ?>
                              </div>
                              <div class="form-group"align="justify">
                                <label for="selesai" >jam selesai:</label>
                                  <input type="time" class="form-control" id="selesai" name="selesai" placeholder="selesai" value="<?= $suratramai["selesai"]; ?>"> 
                              ...
                              <div class="form-group">
                                  ...
                                  value="<?= $suratramai["acara"]; ?>"> 
                                  <?= form_error('acara', '<small class="text-danger pl-3">', '</small>'); ?>
                              </div>
                              <div class="form-group">
                                <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="Masukan Alamat" ><?= $suratramai["alamat"]; ?></textarea>
