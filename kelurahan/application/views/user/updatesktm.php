...
<div class="container" style="background-color: white; border-radius: 10px"><br>
      ...
      <?= $this->session->flashdata('pesan'); ?>
                              <h1 class="h4 text-gray-900 mb-4" font="timnes">Ubah Surat Keterangan Tidak Mampu</h1>
                          </div>
                          <form class="user" method="post" action="<?= base_url('user/updatesktm'); ?>" enctype="multipart/form-data" >
                          <input type="text" class="form-control" id="nosurat" name="nosurat" placeholder="email" value="<?= $sktm['nosurat']; ?>" hidden> 
                              ...
                              <label for="selesai" >No Telepon:</label>
                                  ...
                                  placeholder="nohp"  onkeypress="return hanyaAngka(event)" value="<?= $sktm['notelepon']; ?>">
                              </div>
                              <div class="form-group"align="justify">
                                  <input type="text" class="form-control" id="keperluan" name="keperluan" placeholder="keperluan" value="<?=$sktm['keperluan'];?> ">
                                  <?= form_error('keperluan', '<small class="text-danger pl-3">', '</small>'); ?>
                              </div>
                              <div class="form-group"align="justify">
                              <label for="selesai" >Email</label>
                                  <input type="text" class="form-control" id="email" name="email" placeholder="email" value="<?=$sktm['email'];?> "> 
