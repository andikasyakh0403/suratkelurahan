...
<div class="container" style="background-color: white; border-radius: 10px"><br>
      ...
      <?= $this->session->flashdata('pesan'); ?>
                              <h1 class="h4 text-gray-900 mb-4" font="timnes">Update surat Permohonan Akte Kelahiran</h1>
                          </div>
                          <form class="user" method="post" action="<?= base_url('user/updatesuratkelahiran1'); ?>" enctype="multipart/form-data" >
                          <input type="text" class="form-control" id="nosurat" name="nosurat" placeholder="Masukan NIK"   
                                  hidden
                                  value="<?= $suratkelahiran["nosurat"]; ?>">
                            
                              <div class="form-group"align="justify">
                              
                                  <input type="text" class="form-control" id="nik" name="nik" placeholder="Masukan NIK " maxlength="16" onkeypress="return 
                                  hanyaAngka(event)"  value="<?= $suratkelahiran["nik"]; ?>"
                                   required>
                              ...
                              <div class="form-group"align="justify">
                                  ...
                                  placeholder="namaanak"  value="<?= $suratkelahiran["namaanak"]; ?>"required>
                              </div>
                              <div class="form-group"align="justify">
                            
                                  <input type="text" class="form-control" id="harilahir" name="harilahir" 
                                
                                  placeholder="harilahir"  value="<?= $suratkelahiran["harilahir"]; ?>" required>
                              </div>
                              <div class="form-group"align="justify">
                            
                            <input type="text" class="form-control" id="tempatlahir" name="tempatlahir" 
                          
                            placeholder="tempatlahir"value="<?= $suratkelahiran["tempatlahir"]; ?>"   required>
                        </div>
                              <div class="form-group"align="justify">
                              <label for="selesai" >Jam lahir:</label>
                                  <input type="time" class="form-control" required id="jamlahir" name="jamlahir"value="<?= $suratkelahiran["jamlahir"]; ?>"  > 
                                 
                              </div>
                              
                              <div class="form-group"align="justify">
                              <label for="selesai" >Tanggal Kelahiran:</label>
                                  <input type="date" class="form-control" id="tgllahir" name="tgllahir" placeholder="tglkelahiran" value="<?= $suratkelahiran["tgllahir"]; ?>" required> 
                              ...
                              <div class="form-group"align="justify">
                                  ...
                                  placeholder="anakke" value="<?= $suratkelahiran["anakke"]; ?>"  required>
                              </div>
                              
                              <div class="form-group"align="justify">
                             
                                  <input type="select" class="form-control" id="namaibu" name="namaibu" placeholder="namaibu" value="<?= $suratkelahiran["namaibu"]; ?>" required> 
                              ...
                              <div class="form-group"align="justify">
                                  ...
                                  placeholder="namaayah" value="<?= $suratkelahiran["namaayah"]; ?>"  required>
                              </div>
                             ...
                             <input type="radio" id="jeniskelamin" name="jeniskelamin" value="perempuan"  required/>
                              ...
                              <label for="selesai" >Surat Keterangan (Rt/Rw/Rumah Sakit):</label>
                                  <input type="file" class="form-control" id="suratketerangan" name="suratketerangan" placeholder="suratketerangan" > 
