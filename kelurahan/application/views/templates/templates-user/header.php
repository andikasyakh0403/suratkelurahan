...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url('assets/img/upload/kelurahan keagungan.png'); ?>">
    <title> <?= $judul; ?></title>
                ...
                <?php
                 if (!empty($this->session->userdata('email'))) { ?> 
                   ...
                   <?php } else { ?>
                      ...
                      <?php } ?> 
                      <span class="nav-item nav-link nav-right" style="display:block; margin-left:20px;">Selamat Datang <b></b></span> 
                  </div>
                   </div>
                    </div>
                     </nav>
